...
public class SnakeYamlOptimized
{
	public static void register(TestGroups groups)
	{
		groups.media.add(JavaBuiltIn.MediaTransformer, SnakeYamlOptimized.<MediaContent>GenericSerializer());
	}
	...
	public static Serializer<Object> GenericSerializer = new Serializer<Object>()
	{
		...
		{
			return "yaml/snakeyaml-optimized";
		}
	};
}
